...
module.exports = poll => {
  ...
  <body>
    <div style="text-align: center;">
      ...
      <div>
        <a style="font-size:1.5rem; color:red;" href="${
          keys.redirectDomain
        }/api/polls/thanks"><strong>${repCandidate} (R)</strong></a>
      </div>
      <p>OR </p>
      <div>
        <a style="font-size:1.5rem; color:blue;" href="${
          keys.redirectDomain
        }/api/polls/thanks"><strong>${demCandidate}</strong> (D)</a>
      </div>
